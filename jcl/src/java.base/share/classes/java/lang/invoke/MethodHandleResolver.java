...
/*[IF OPENJDK_METHODHANDLES]*/
		...
		try {
			...
			/* TODO: Currently, result[0] either stores a MemberName or Throwable. This leads to a type check in the interpreter
			 * for the object stored in result[0]. Investigate if the Throwable can be wrapped in a MemberName. This will help
			 * prevent type checks in the interpreter since result[0] will always be a MemberName. This will improve performance.
			 */
		}
