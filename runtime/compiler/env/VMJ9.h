...
/////
   ...
   */
   ...
   virtual TR_ResolvedMethod * createResolvedMethod(TR_Memory *, uint32_t vTableSlot, TR_OpaqueMethodBlock * aMethod, TR_ResolvedMethod * owningMethod = 0, TR_OpaqueClassBlock * classForNewInstance = 0);
