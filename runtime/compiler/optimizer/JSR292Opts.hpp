...
#ifndef JSR292Opts_INCL
#define JSR292Opts_INCL
...
class TR_JSR292Opts : public TR::Optimization
   {
   public:
   TR_JSR292Opts(TR::OptimizationManager *manager) : TR::Optimization(manager) {}
   static TR::Optimization *create(TR::OptimizationManager *manager)
      {
      return new (manager->allocator()) TR_JSR292Opts(manager);
      }
