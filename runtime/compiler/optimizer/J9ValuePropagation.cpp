...
typesAreConvertible(TR_J9VMBase* fej9, TR_OpaqueClassBlock* fromClazz, TR_OpaqueClassBlock* toClazz)
   {
...
static TR_YesNoMaybe
returnTypesAreConvertibleBetweenMethodTypes(TR_J9VMBase* fej9, uintptrj_t fromMethodType, uintptrj_t toMethodType)
   {
   ...
   return typesAreConvertible(fej9, fromClazz, toClazz);
   }

static TR_YesNoMaybe
argumentsAreConvertibleBetweenMethodTypes(TR_J9VMBase* fej9, uintptrj_t fromMethodType, uintptrj_t toMethodType)
   {
   ...
   for (int i=0; i< fromArgNum; i++)
      ...
      TR_YesNoMaybe tmpResult = typesAreConvertible(fej9, fromArgClazz, toArgClazz);
      if (tmpResult == TR_no)
         return TR_no;
...
static TR_YesNoMaybe
canInvokeMethodHandleWithType(TR_J9VMBase* fej9, uintptrj_t methodHandle, uintptrj_t newType)
   {
   ...
   TR_YesNoMaybe returnTypesConvertible = returnTypesAreConvertibleBetweenMethodTypes(fej9, mhType, newType);
   TR_YesNoMaybe argumentsConvertible = argumentsAreConvertibleBetweenMethodTypes(fej9, newType, mhType);
...
J9::ValuePropagation::processAsTypeCallNew(TR::Node* node)
   ...
   if (mhConstraint
      ...
      if (canInvokeMethodHandleWithType(fej9, mhObject, mtObject) == TR_no)
         {
         if (trace())
