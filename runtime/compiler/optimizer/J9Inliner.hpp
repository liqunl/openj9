...
class TR_J9InlinerPolicy : public OMR_InlinerPolicy
   ...
   protected:
      ...
      /** \brief
       *     This query defines a group of methods that are leaf method handles invokeExact in the java/lang/invoke package
       */
      static bool isJSR292LeafHandleInvoke(TR_ResolvedMethod *resolvedMethod);
   };
